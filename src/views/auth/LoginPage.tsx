...
import {
  ...
  CardHeader,
  CardTitle,
} from "@/views/dashboard/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/views/dashboard/ui/tabs";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <CardHeader>
            <motion.div variants={itemVariants}>
              ...
              >
                Sign in to continue to SeniorThrive
              </CardDescription>
            </motion.div>
          </CardHeader>
        ...
        <motion.p
          variants={itemVariants}
          className={`text-center mt-8 text-sm ${darkMode ? "text-slate-400" : "text-slate-600"}`}
        >
          By signing in, you agree to our{" "}
          <Link
            to="/terms"
            className={`underline ${darkMode ? "text-slate-300" : "text-slate-700"}`}
          >
            Terms of Service
          </Link>{" "}
          and{" "}
